...
(function() {
  var OPERATORS, PRECEDENCE, SIGILS, VARIABLES, _, apply, calculate, canonical, cast, commute, compare, depth, destructured, diff, flip, hasPrecedence, i, isCommutative, isExpression, isNumber, isOperator, isScalar, isSimple, isSimpleExpression, isString, isVariable, leftmost, match, modifies, needs, nest, order, parse, patterns, rank, ref, rightmost, shunt, substitute, sum, test, tokenize, tuples, unwrap, variables,
